...
}:
{
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      monitor = [
        "eDP-1, 2880x1800@60.00, 0x1800, 2.00, transform, 2, bitdepth, 10, cm, hdr, sdrbrightness,1.5, sdrsaturation,1.0"
        "eDP-2, 2880x1800@60.00, 0x0, 2.00, bitdepth, 10, cm, hdr,sdrbrightness,1.5,sdrsaturation,1.0"
      ];
